...
# load domain data into module

# repeat 10x
# create module for instance data
# import instance data via python adding frames
# query instance data referencing domain data
# run rule that inserts additional instance data using
# domain data classes
# query and export inserted data into python
# remove module
